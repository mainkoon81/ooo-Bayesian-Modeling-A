...
### > Find the parameters...
 ...
 - ### (3) between results ? **`P( likelihood_A | likelihood_B )`** <*><*><*><*><*> important!!!
   ...
   - There goes magic!! If we see the prior is the latent/hidden variable, then dealing with the features at hand becomes super simple since they are independent each other! 
